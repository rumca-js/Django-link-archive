        ...
        if self.entry.bookmarked:
            buttons.append( 
                EntryButton(
                    ...
                    ConfigurationEntry.ACCESS_TYPE_OWNER,
                    "Unbookmark entry",
                    static("{}/icons/icons8-not-bookmark-100.png".format(LinkDatabase.name)),
                )
            )
        else:
            buttons.append( 
                EntryButton(
                    ...
                    ConfigurationEntry.ACCESS_TYPE_OWNER,
                    "Bookmark entry",
                    static("{}/icons/icons8-bookmark-100.png".format(LinkDatabase.name)),
                )
            )
        ...
        if not self.entry.dead:
            buttons.append(
                EntryButton(
                    ...
                    "Hide",
                    reverse(
                        "{}:entry-hide".format(LinkDatabase.name),
                        args=[self.entry.id],
                    ),
                    ConfigurationEntry.ACCESS_TYPE_OWNER,
                    "Hides entry: {}".format(self.entry.title),
                ),
            )
        else:
            buttons.append(
                EntryButton(
                    ...
                    "Unhide",
                    reverse(
                        "{}:entry-unhide".format(LinkDatabase.name),
                        args=[self.entry.id],
                    ),
                    ConfigurationEntry.ACCESS_TYPE_OWNER,
                    "Unhides entry: {}".format(self.entry.title),
                ),
            )

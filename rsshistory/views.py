...
from .forms import NewLinkForm, ImportLinksForm, ChoiceForm, EntryChoiceForm
...
class RssEntriesListView(generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        category_form = EntryChoiceForm(filters = self.get_filters())

...
class BlockEntryList(models.Model):
    ...
    def initialize():
        BlockEntryList.read_lists_group("https://v.firebog.net/hosts/lists.php?type=tick")
    ...
    def update():
        ...
        for item in BlockEntryList.objects.all():
            BackgroundJobController.create_single_job(BackgroundJobController.JOB_INITIALIZE_BLOCK_LIST,
                item.url)

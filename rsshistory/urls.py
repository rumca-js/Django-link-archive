...
urlpatterns = [
    ...
    path(
        "source/<int:pk>/",
        viewsources.RssSourceDetailView.as_view(),
        name="source-detail",
    ),
    ...
    path(
        "sources-remove-all/", viewsources.remove_all_sources, name="sources-remove-all"
    ),
    ...
    path(
        "source-import-yt-links/<int:pk>/",
        viewsources.import_youtube_links_for_source,
        name="source-import-yt-links",
    ),
    path(
        "source-process-text/<int:pk>/",
        viewsources.process_source_text,
        name="source-process-text",
    ),
    # entries
    path("entries/", viewentries.RssEntriesListView.as_view(), name="entries"),
    path(
        "entry/<int:pk>/", viewentries.RssEntryDetailView.as_view(), name="entry-detail"
    ),
    ...
    path(
        "entry-notstar/<int:pk>/",
        viewentries.make_not_persistent_entry,
        name="entry-notstar",
    ),
    path("entries-import", viewentries.import_entries, name="entries-import"),
    path(
        "entries-untagged/",
        viewentries.NotBookmarkedView.as_view(),
        name="entries-untagged",
    ),
    path("searchinitview", viewentries.search_init_view, name="searchinitview"),
    path(
        "entry-download-music/<int:pk>/",
        viewcustom.download_music,
        name="entry-download-music",
    ),
    path(
        "entry-download-video/<int:pk>/",
        viewcustom.download_video,
        name="entry-download-video",
    ),
    ...
    path(
        "tags-entry-remove/<int:entrypk>/",
        viewtags.tags_entry_remove,
        name="tags-entry-remove",
    ),
    path(
        "tags-entry-show/<int:entrypk>/",
        viewtags.tags_entry_show,
        name="tags-entry-show",
    ),
    ...
    # comment
    path(
        "entry-comment-add/<int:link_id>",
        viewcomments.entry_add_comment,
        name="entry-comment-add",
    ),
    path(
        "entry-comment-edit/<int:pk>/",
        viewcomments.entry_comment_edit,
        name="entry-comment-edit",
    ),
    path(
        "entry-comment-remove/<int:pk>/",
        viewcomments.entry_comment_remove,
    ...
    path(
        ...
        viewcustom.start_threads,
        name="start-background-threads",
    ),
    path(
        "backgroundjobs/",
        viewcustom.BackgroundJobsView.as_view(),
        name="backgroundjobs",
    ),
    path(
        "backgroundjob-remove/<int:pk>/",
        viewcustom.backgroundjob_remove,
        name="backgroundjob-remove",
    ),
    path(
        "backgroundjobs-remove/<str:job_type>/",
        viewcustom.backgroundjobs_remove,
        name="backgroundjobs-remove",
    ),
    path("write-bookmarks", viewcustom.write_bookmarks, name="write-bookmarks"),
    path(
        "write-daily-data-form",
        viewcustom.write_daily_data_form,
        name="write-daily-data-form",
    ),
    path("write-tag-form", viewcustom.write_tag_form, name="write-tag-form"),
    path(
        "import-reading-list",
        viewcustom.import_reading_list_view,
        name="import-reading-list",
    ),
    path(
        "import-source-ia/<int:pk>/",
        viewcustom.import_source_from_ia,
        name="import-source-ia",
    ),
    ...
    path(
        "entry-fix-youtube-details/<int:pk>/",
        viewcustom.fix_reset_youtube_link_details_page,
        name="entry-fix-youtube-details",
    ),
    path(
        "fix-entry-tags/<int:entrypk>/",
        viewcustom.fix_entry_tags,
        name="fix-entry-tags",
    ),
    path(
        "fix-source-entries-lan/<int:pk>/",
        viewcustom.fix_source_entries_language,
        name="fix-source-entries-lan",
    ),
    path(
        "show-yt-props",
        viewcustom.show_youtube_link_props,
        name="show-youtube-link-props",
    ),

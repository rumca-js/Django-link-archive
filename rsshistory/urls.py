...
# fmt: off
urlpatterns = [
    path("", viewsystem.index, name="index"),
    # sources
    ...
    path("source-pause/<int:pk>/", viewsources.pause, name="source-pause"),
    ...
    path("backgroundjobs-enable-all/", viewsystem.backgroundjobs_enable_all, name="backgroundjobs-enable-all",),
    path("backgroundjobs-disable-all/", viewsystem.backgroundjobs_disable_all, name="backgroundjobs-disable-all",),
    ...
    path("wizard-setup-gallery", viewsystem.wizard_setup_gallery, name="wizard-setup-gallery",),
    path("wizard-setup-search-engine", viewsystem.wizard_setup_search_engine, name="wizard-setup-search-engine",),

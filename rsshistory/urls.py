...
urlpatterns = [
    ...
    path("entry-star/<int:pk>/", viewentries.make_bookmarked_entry, name="entry-star"),
    path("entry-notstar/<int:pk>/", viewentries.make_not_bookmarked_entry, name="entry-notstar"),

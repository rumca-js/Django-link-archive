...
urlpatterns = [
    ...
    path('source-import-yt-links/<int:pk>/', viewsources.import_youtube_links_for_source,
    ...
    path('entry-fix-youtube-details/<int:pk>/', viewcustom.fix_reset_youtube_link_details_page,

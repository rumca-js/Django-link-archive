...
urlpatterns = [
    ...
    path("api/entries/", entries.entries_json, name="entries-json"),
    path("api/entries-user-bookmarked/", entries.entries_json_user_bookmarked, name="entries-json-user-bookmarked"),
    path("api/entries-archived/", entries.entries_json_archived, name="entries-json-archived"),
    ...
    path("api/entry/<int:pk>/", entries.entry_json, name="entry-json"),
    path("entry-archived/<int:pk>/", entries.EntryArchivedDetailView.as_view(), name="entry-archived"),
    path("api/entry-add", entries.add_entry_json, name="entry-add-json"),
    ...
    path("api/entry-remove/<int:pk>/", entries.entry_remove, name="json-entry-remove"),
    ...
    path("api/entry-bookmark/<int:pk>/", entries.entry_bookmark, name="json-entry-bookmark"),
    path("api/entry-unbookmark/<int:pk>/", entries.entry_unbookmark, name="json-entry-unbookmark"),
    ...
    path("api/entry-menu/<int:pk>/", entries.json_entry_menu, name="json-entry-menu"),
    # sources
    path("sources/", sources.sources, name="sources"),
    path("source/<int:pk>/", sources.SourceDetailView.as_view(), name="source-detail"),
    path("api/source/<int:pk>/", sources.source_json, name="source-json"),
    path("api/sources-all/", sources.sources_json_all, name="sources-json-all"),
    path("sources-opml/", sources.sources_opml, name="sources-opml"),
    path("api/sources-enabled/", sources.sources_json_enabled, name="sources-json-enabled"),
    path("api/sources-initialize/", sources.json_sources_initialize, name="json-sources-initialize"),
    ...
    path("api/domain/<int:pk>/", domains.domain_json, name="domain-json",),
    ...
    path("api/domains/", domains.domains_json, name="domains-json"),
    ...
    path("api/configuration-advanced/", system.configuration_advanced_json, name="configuration-advanced-json"),
    ...
    path("api/wizard-setup-news", system.json_wizard_setup_news, name="json-wizard-setup-news",),
    path("api/wizard-setup-gallery", system.json_wizard_setup_gallery, name="json-wizard-setup-gallery",),
    path("api/-wizard-setup-search-engine", system.json_wizard_setup_search_engine, name="json-wizard-setup-search-engine",),
    ...
    path("api/indicators", system.json_indicators, name="json-indicators",),
    path("api/table-status/", system.json_table_status, name="json-table-status"),
    path("api/system-status/", system.json_system_status, name="json-system-status"),
    path("api/system-monitoring/", system.json_system_monitoring, name="json-system-monitoring"),
    path("api/settings/", system.json_settings, name="json-settings"),
    path("api/search-container", system.json_search_container, name="json-search-container",),
    path("api/global-container", system.json_global_container, name="json-global-container",),
    path("api/personal-container", system.json_personal_container, name="json-personal-container",),
    path("api/tools-container", system.json_tools_container, name="json-tools-container",),
    path("api/users-container", system.json_users_container, name="json-users-container",),
    # users
    ...
    # other
    path("api/read-later-add/<int:pk>/", readlater.read_later_add, name="json-read-later-add"),
    path("api/read-later-remove/<int:pk>/", readlater.read_later_remove, name="json-read-later-remove"),
    path("api/read-later-clear/", readlater.json_read_later_clear, name="json-read-later-clear"),
    ...
    path("api/logs/", system.json_logs, name="json-logs",),
    ...
    path("api/entry-rules/", entryrules.entry_rules_json, name="entry-rules-json",),
    ...
    path("api/block-lists", blockentry.blocklists_json, name="block-lists-json",),
    ...
    path("api/cleanup-link", tools.cleanup_link_json, name="cleanup-link-json",),
    path("api/link-input-suggestions", tools.link_input_suggestions_json, name="link-input-suggestions-json",),
    path("api/source-input-suggestions", tools.source_input_suggestions_json, name="source-input-suggestions-json",),
    # json and ajax
    ...
    path("api/export-status/", system.json_export_status, name="json-export-status"),
    ...
    path("api/entry-related/<int:pk>/", entries.entry_related_json, name="entry-related-json"),
    ...
    path("api/backgroundjobs/", backgroundjobs.backgroundjobs_json, name="backgroundjobs-json",),
    path("api/user-search-history", userhistory.json_user_search_history, name="json-user-search-history"),
    ...
    path("api/page-properties", tools.json_page_properties, name="json-page-properties",),
